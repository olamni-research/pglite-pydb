...
class TestDjangoImports:
    ...
    def test_has_django_flag_with_django_available(self):
        ...
        from pglite_pydb.django.fixtures import HAS_DJANGO
    ...
    def test_import_constants_are_set(self):
        ...
        from pglite_pydb.django import fixtures
...
class TestDjangoUtilsFunctionality:
    ...
    def test_django_utils_has_django_flag(self):
        ...
        from pglite_pydb.django.utils import HAS_DJANGO
    ...
    def test_create_django_test_database_without_django(self):
        ...
        from pglite_pydb.django.utils import create_django_test_database

        mock_manager = Mock()

        with patch("pglite_pydb.django.utils.HAS_DJANGO", False):
    ...
    def test_create_django_test_database_success(self):
        ...
        with (
            patch("pglite_pydb.django.utils.HAS_DJANGO", True),
            patch("pglite_pydb.django.utils.migrate_django_database") as mock_migrate,
        ):
    ...
    def test_destroy_django_test_database(self):
        ...
        from pglite_pydb.django.utils import destroy_django_test_database
    ...
    def test_migrate_django_database_without_django(self):
        ...
        from pglite_pydb.django.utils import migrate_django_database
    ...
    def test_migrate_django_database_success(self):
        ...
        with (
            patch("pglite_pydb.django.utils.HAS_DJANGO", True),
            patch("pglite_pydb.django.utils.call_command", mock_call_command),
        ):
    ...
    def test_flush_django_database_without_django(self):
        ...
        from pglite_pydb.django.utils import flush_django_database
    ...
    def test_configure_django_for_pglite_already_configured(self):
        ...
        with (
            patch("pglite_pydb.django.utils.HAS_DJANGO", True),
            patch("pglite_pydb.django.utils.settings", mock_settings),
            patch("pglite_pydb.django.utils.django", mock_django),
        ):
            configure_django_for_pglite()
    ...
    def test_configure_django_for_pglite_success(self):
        ...
        with (
            ...
            assert db_config["ENGINE"] == "pglite_pydb.django.backend"
    ...
    def test_get_django_connection_params(self):
        ...
        from pglite_pydb.django.utils import get_django_connection_params
        ...
        assert params["ENGINE"] == "pglite_pydb.django.backend"
    ...
    def test_is_django_configured_without_django(self):
        ...
        from pglite_pydb.django.utils import is_django_configured
    ...
    def test_get_django_models_without_django(self):
        ...
        from pglite_pydb.django.utils import get_django_models
